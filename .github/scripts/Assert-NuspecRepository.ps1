...
.DESCRIPTION
    ...
    restores fine but cannot be traced back to source. This fails the release instead of shipping it.
#>
[CmdletBinding()]
param(
    [Parameter(Mandatory)]
...
Assert-Value 'copyright' (Get-MetadataValue 'copyright') $null
